                ...
                <div class="bg-white rounded-2xl shadow-md overflow-hidden">
                    ...
                    <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                        <div class="flex items-center gap-2.5">
                            ...
                            <h3 class="text-base font-bold text-gray-900">Upload Foto</h3>
                        </div>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div id="photo-dropzone"
                            ...
                            <p class="font-bold text-gray-800 mb-1 pointer-events-none">Seret &amp; lepas foto di sini</p>
                        ...
                        <div id="file-list-wrapper" class="hidden">
                            <div class="flex items-center justify-between mb-3">
                                <p class="text-sm font-bold text-gray-700">Foto terpilih</p>
