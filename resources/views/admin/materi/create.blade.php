                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex gap-2">
                            <select id="category_id" name="category_id" required
                                class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500/20 transition bg-gray-50 focus:bg-white @error('category_id') border-red-500 @enderror">
