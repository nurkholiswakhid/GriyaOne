...
@section('title', 'Tambah Materi PDF - GriyaOne')
@section('role', 'Tambah Materi PDF')
...
@section('content')
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-8 fade-in">
            ...
            <h2 class="text-3xl font-bold text-gray-900 mb-2">Tambah Materi PDF</h2>
            <p class="text-gray-600">Buat materi pembelajaran baru dalam bentuk PDF</p>
        </div>

        <!-- Form -->
        <form action="{{ route('materi.store') }}" method="POST" enctype="multipart/form-data" class="fade-in">
            @csrf
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="p-8">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="title" name="title" value="{{ old('title') }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500/20 transition bg-gray-50 focus:bg-white @error('title') border-red-500 @enderror" placeholder="Masukkan judul materi">
                        @error('title')
                        ...
                        <div class="flex items-end gap-3">
                            <div class="flex-1">
                                <select id="category_id" name="category_id" required
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500/20 transition bg-gray-50 focus:bg-white @error('category_id') border-red-500 @enderror">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <input type="file" id="file_path" name="file_path" accept=".pdf" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500/20 transition bg-gray-50 focus:bg-white @error('file_path') border-red-500 @enderror" onchange="updateFileName(this)">
                            <p class="text-xs text-gray-500 mt-1">Format: PDF. Ukuran maksimal: 50MB</p>
                        </div>
                    ...
                    <div class="mb-6">
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" id="is_published" name="is_published" value="1" {{ old('is_published') ? 'checked' : '' }} class="w-4 h-4 rounded border-gray-300 text-red-600">
    ...
    <script>
        ...
        async function reloadCategories() {
            try {
                const response = await fetch('{{ route("materi.create") }}');
