        ...
        <div class="pt-4">
            <div class="mx-4 mb-5 bg-white rounded-lg border border-gray-200 p-3 shadow-sm">
                <div class="flex items-center gap-3">
                    ...
                    @else
                        <div class="w-10 h-10 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full flex items-center justify-center text-white font-bold text-base flex-shrink-0">{{ $authUser ? strtoupper(substr($authUser->name, 0, 1)) : 'M' }}</div>
                    @endif
