    ...
    <nav class="sticky top-0 z-50 bg-white shadow-sm border-b border-orange-100">
        <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <button class="relative p-2 text-gray-600 hover:text-orange-600 transition flex-shrink-0">
        ...
        <aside class="w-64 bg-gradient-to-b from-white to-orange-50 border-r border-gray-200 min-h-screen pt-4 fixed left-0 top-16 bottom-0 overflow-y-auto lg:relative lg:top-0 hidden lg:block scrollbar-hide">
            ...
            <div class="mx-4 mb-6 bg-white rounded-lg border border-gray-200 p-4 shadow-sm hover:shadow-md transition-shadow duration-200">
                <div class="flex items-center gap-3">
                    ...
                    <div class="min-w-0 flex-1">
                        <h3 class="font-semibold text-gray-900 text-sm truncate">Marketing Team</h3>
                        <p class="text-xs text-gray-500 truncate">marketing@test.com</p>
                    </div>
                </div>
            </div>
            ...
            <nav class="px-2 space-y-1">
                ...
                <a href="{{ route('marketing.assets') }}" class="group flex items-center justify-between px-4 py-3 text-gray-700 hover:text-orange-600 hover:bg-orange-50 font-medium text-sm transition-colors duration-200 rounded-lg">
                    ...
                    <span class="bg-orange-100 text-orange-600 text-xs font-semibold px-2 py-0.5 rounded-full group-hover:bg-orange-200 transition-colors duration-200">12</span>
                </a>
                ...
                <a href="{{ route('marketing.learning') }}" class="group flex items-center justify-between px-4 py-3 text-gray-700 hover:text-orange-600 hover:bg-orange-50 font-medium text-sm transition-colors duration-200 rounded-lg">
                    ...
                    <span class="bg-orange-100 text-orange-600 text-xs font-semibold px-2 py-0.5 rounded-full group-hover:bg-orange-200 transition-colors duration-200">28</span>
                </a>

                <div class="text-xs font-semibold text-gray-500 px-4 py-3 uppercase tracking-wider mt-6">Notifikasi</div>

                <a href="{{ route('marketing.notifications') }}" class="group flex items-center justify-between px-4 py-3 text-gray-700 hover:text-orange-600 hover:bg-orange-50 font-medium text-sm transition-colors duration-200 rounded-lg">
                    <div class="flex items-center gap-3">
                        <svg class="w-5 h-5 flex-shrink-0 text-gray-400 group-hover:text-orange-600 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path>
                        </svg>
                    ...
                    <span class="bg-red-100 text-red-600 text-xs font-semibold px-2 py-0.5 rounded-full group-hover:bg-red-200 transition-colors duration-200">5</span>
                </a>
            ...
            <div class="mx-4 mt-8 mb-8 bg-gradient-to-br from-orange-50 via-orange-50 to-orange-100 border-l-4 border-orange-400 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow duration-200">
                <div class="flex items-start gap-2">
                    <span class="text-xl flex-shrink-0 animate-bounce">📊</span>
                    <div class="min-w-0">
                        <h4 class="font-bold text-gray-900 text-sm mb-1">Tips Kampanye</h4>
                        <p class="text-xs text-gray-700 leading-relaxed">Gunakan data analytics untuk mengoptimalkan kampanye dan meningkatkan ROI Anda.</p>
                        <button class="mt-2 text-xs font-semibold text-orange-600 hover:text-orange-700 transition-colors duration-200">Pelajari lebih lanjut →</button>
                    </div>
                </div>
            </div>
        </aside>
